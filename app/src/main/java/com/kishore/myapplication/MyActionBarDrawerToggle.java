...
public class MyActionBarDrawerToggle implements MyDrawerLayout.DrawerListener {
    ...
    public interface DelegateProvider {
         ...
         */
        @Nullable
        MyActionBarDrawerToggle.Delegate getDrawerToggleDelegate();
    }
    ...
    private final MyActionBarDrawerToggle.Delegate mActivityImpl;
    private final MyDrawerLayout mDrawerLayout;
     ...
     *                                  for accessibility
     */
    public MyActionBarDrawerToggle(Activity activity, MyDrawerLayout drawerLayout,
     ...
     * animation.
     */
    MyActionBarDrawerToggle(Activity activity, Toolbar toolbar, MyDrawerLayout drawerLayout,
                          DrawerArrowDrawable slider, @StringRes int openDrawerContentDescRes,
                          @StringRes int closeDrawerContentDescRes) {
        if (toolbar != null) {
            mActivityImpl = new MyActionBarDrawerToggle.ToolbarCompatDelegate(toolbar);
        ...
        } else if (activity instanceof MyActionBarDrawerToggle.DelegateProvider) { // Allow the Activity to provide an impl
            mActivityImpl = ((MyActionBarDrawerToggle.DelegateProvider) activity).getDrawerToggleDelegate();
        } else {
            mActivityImpl = new MyActionBarDrawerToggle.FrameworkActionBarDelegate(activity);
        }
    ...
    void toggle() {
        ...
        if (mDrawerLayout.isDrawerVisible(GravityCompat.START)
                && (drawerLockMode != MyDrawerLayout.LOCK_MODE_LOCKED_OPEN)) {
            mDrawerLayout.closeDrawer(GravityCompat.START);
        } else if (drawerLockMode != MyDrawerLayout.LOCK_MODE_LOCKED_CLOSED) {
    ...
    private static class FrameworkActionBarDelegate implements MyActionBarDrawerToggle.Delegate {
     ...
     */
    static class ToolbarCompatDelegate implements MyActionBarDrawerToggle.Delegate {
