...
class ActionBarDrawerToggleHoneycomb {
    ...
    public static ActionBarDrawerToggleHoneycomb.SetIndicatorInfo setActionBarUpIndicator(Activity activity,
    ...
    public static ActionBarDrawerToggleHoneycomb.SetIndicatorInfo setActionBarDescription(ActionBarDrawerToggleHoneycomb.SetIndicatorInfo info, Activity activity,
                                                                                                                 int contentDescRes) {
        if (info == null) {
